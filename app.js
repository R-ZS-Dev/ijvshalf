...
// 
app.get(archive + '/viewpn/:id', archiveController.viewpn);
app.post(sitevisitor + '/cvistor', vistorController.createVistor);
app.post(sitevisitor + '/evistor/:id:no', vistorController.editVistor);
